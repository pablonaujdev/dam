...
class EDIExchangeOutputTemplate(models.Model):
    ...
    # add a good domain (maybe add a new flag or category to ir.ui.view)
    # Options:
    ...
    # find a way to prevent editing "master templates"
    ...
    def _post_process_output(self, output):
        ...
        if self.output_type == "xml":
            # lookup for components to handle this dynamically
