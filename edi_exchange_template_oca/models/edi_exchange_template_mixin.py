...
class EDIExchangeTemplateMixin(models.AbstractModel):
    ...
    # make unique, autocompute slugified name
    ...
    backend_id = fields.Many2one(
        ...
        ondelete="cascade",
        # default to type_id if given, validate otherwise
    )
    # add default content w/ comment on what you can use
