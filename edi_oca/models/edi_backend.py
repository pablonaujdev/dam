...
class EDIBackend(models.Model):
    ...
    # unify to all other checkes that return something
    ...
    def exchange_send(self, exchange_record):
        ...
        try:
            ...
            #  maybe the send handler should return desired message and state
            ...
            exchange_record.write(
                {
                    ...
                    #  this should come from _compute_exchanged_on
    ...
    def _exchange_receive_check(self, exchange_record):
        #  use `filtered_domain` + _input_pending_records_domain
    ...
    #  add tests
    #  consider splitting cron in 2 (1 for receiving, 1 for processing)
